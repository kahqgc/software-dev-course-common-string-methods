...
let intro = "Learning JavaScript is fun!";
console.log(intro.includes("JavaScript"));
console.log(intro.indexOf("fun"));
...
let header = "Coding is fun and educational";
...
let customerName = ("Customer: John Doe");
let order = ("Apple, Banana, Grape");
let total = ("TOTAL: $20.50")

let extractedName = customerName.slice(10);
let orderArray = order.split(",");
let totalCamel = total.toUpperCase();
console.log(extractedName);
console.log(orderArray);
console.log(totalCamel);
